...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "jackieblog.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "jackieblog.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "jackieblog.mail.routing.key";
}
